...
from app.routers import auth, food_options, me, users_admin
...
app = FastAPI(
    ...
    "Send **`X-User-Id`** (user id from login) on `/api/me/*` so profile and food-options CRUD target that account. "
